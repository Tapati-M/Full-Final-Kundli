...
const AstrologerList = () => {
  ...
  // Determine if the user navigated here from a specific page
  ...
  return (
    <div className="py-8 px-4 md:px-6 lg:px-16 relative">
...
{fromPage && (
  <div className="flex justify-start mb-4 md:mb-6">
    <button
      onClick={() => navigate(-1)}
      className="bg-gradient-to-r from-indigo-600 to-fuchsia-300 hover:from-yellow-300 text-white hover:text-black font-bold px-4 py-2 rounded text-sm md:text-base shadow-lg transition-transform hover:scale-105"
    >
      Go Back
    </button>
  </div>
